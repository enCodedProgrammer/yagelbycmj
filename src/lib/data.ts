...
export const products: Product[] = [
  {
    ...
    image: "/images/yagel-f.png",
    gallery: [
      { src: "/images/yagel-f.png", alt: "Yagel For Her — Front View" },
      { src: "/images/yagel-f.png", alt: "Yagel For Her — Side View" },
      { src: "/images/yagel-f.png", alt: "Yagel For Her — Back View" },
    ],
    gender: "her",
  },
  {
    ...
    image: "/images/yagel-m.png",
    gallery: [
      { src: "/images/yagel-m.png", alt: "Yagel For Him — Front View" },
      { src: "/images/yagel-m.png", alt: "Yagel For Him — Side View" },
      { src: "/images/yagel-m.png", alt: "Yagel For Him — Back View" },
    ],
    gender: "him",
  },
];
